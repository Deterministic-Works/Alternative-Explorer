...
- Browse an expandable folder tree; chevron expands nested folders inline, and tapping a folder opens its notes. Use **Expand all** / **Fold all** in the folders header to open or close every nested folder at once.

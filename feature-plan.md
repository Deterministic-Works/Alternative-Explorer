...
- Folders header **Expand all** / **Fold all** expands every vault folder that has subfolders and opens all sections, or clears folder expansion and collapses all sections (persisted).
